...
; See LICENSE
#define GuiVersion GetFileVersion("bin\aimonit-wallet-gui.exe")
...
DefaultDirName={commonpf}\Aimonit GUI Wallet
DefaultGroupName=Aimonit GUI Wallet
UninstallDisplayIcon={app}\aimonit-wallet-gui.exe
...
AppPublisherURL=https://aimonitor.world
TimeStampsInUTC=yes
...
Source: "bin\aimonit-wallet-gui.exe"; DestDir: "{app}"; Flags: ignoreversion
...
; Filename: "{app}\aimonit-wallet-gui.exe"; Description: "Run GUI Wallet now"; Flags: postinstall nowait skipifsilent
...
Name: "{group}\GUI Wallet"; Filename: "{app}\aimonit-wallet-gui.exe";
Name: "{group}\GUI Wallet Guide"; Filename: "{app}\monero-gui-wallet-guide.pdf"; IconFilename: "{app}\aimonit-wallet-gui.exe"
...
Name: "{group}\Utilities\x (Check GUI Wallet Log)"; Filename: "Notepad"; Parameters: """{userappdata}\aimonit-wallet-gui\aimonit-wallet-gui.log"""
...
Name: "{commondesktop}\GUI Wallet"; Filename: "{app}\aimonit-wallet-gui.exe"; Tasks: desktopicon
...
Root: HKCR; Subkey: "monero\DefaultIcon"; ValueType: "string"; ValueData: "{app}\aimonit-wallet-gui.exe,0"
Root: HKCR; Subkey: "monero\shell\open\command"; ValueType: "string"; ValueData: """{app}\aimonit-wallet-gui.exe"" ""%1"""
...
Root: HKCR; Subkey: "moneroseed\DefaultIcon"; ValueType: "string"; ValueData: "{app}\aimonit-wallet-gui.exe,0"
Root: HKCR; Subkey: "moneroseed\shell\open\command"; ValueType: "string"; ValueData: """{app}\aimonit-wallet-gui.exe"" ""%1"""
